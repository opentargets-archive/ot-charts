...
class PheWAS extends Component {
  ...
  _render() {
    // console.log('colours', d3.schemePaired);
    ...
    const traitCategoriesSet = assocs.reduce((acc, assoc) => {
      acc[assoc.traitCategory] = true;
      return acc;
    }, {});
    //console.log('traitCategories', traitCategoriesSet);
    //console.log('keys', Object.keys(traitCategoriesSet));

    colourScale.domain(Object.keys(traitCategoriesSet)).range(d3.schemePaired);
