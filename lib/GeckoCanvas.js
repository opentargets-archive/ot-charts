...
class Gecko extends React.Component {
  ...
  _renderGenes(context, hiddenContext, scaleX, track, data) {
    ...
    context.beginPath();
    data.filter(d => d.chained).forEach(d => {
    ...
    data.forEach(d => {
      ...
      // backdrop
      context.fillStyle = backgroundColor(d);
  ...
  _renderTagVariants(context, hiddenContext, scaleX, track, data) {
    context.save();
    hiddenContext.save();
  ...
  _renderIndexVariants(context, hiddenContext, scaleX, track, data) {
    context.save();
    hiddenContext.save();
  ...
  _renderStudies(context, hiddenContext, scaleX, scaleY, track, data) {
    context.save();
    context.translate(0, track.top);
    hiddenContext.save();
    hiddenContext.translate(0, track.top);
