...
class Gecko extends React.Component {
  ...
  _renderLegend(context, width) {
    ...
    // const xSelectedConnector = xSelectedEntity + itemOffset;
    // const xSelectedConnectorFinemapping = xSelectedConnector + itemOffset;
    ...
    // // selected connector
    // context.fillStyle = theme.gecko.connectorColorSelected;
    // context.fillRect(xSelectedConnector, middle - 1, side, 2);
    // context.fillStyle = textColor;
    // context.fillText('link', xSelectedConnector + textOffset, middle);
    // // selected connector finemapping
    // context.fillStyle = theme.gecko.finemappingConnectorColorSelected;
    // context.fillRect(xSelectedConnectorFinemapping, middle - 1, side, 2);
    // context.fillStyle = textColor;
    // context.fillText(
    //   'link (finemapping)',
    //   xSelectedConnectorFinemapping + textOffset,
    //   middle
    // );
    ...
    // labels
    context.font = 'bold 12px sans-serif';
    context.fillText('unselected', xDefaultConnector + textOffset, label);
    context.fillText('selected', xSelectedEntity + textOffset, label);
    context.fillText(
      'selected indirectly',
      xChainedConnector + textOffset,
      label
    );
